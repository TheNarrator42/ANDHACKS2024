...
from routes.stock_game import stock_game_module
import os
import markdown
...
@app.route('/')
def home_page():
    return render_template('home.html')  # Your landing page with options for tutorial or stock game
...
# READING ROUTES
READINGS = os.path.join(frontend_folder, 'readings')
# Ch1 Landing
@app.route('/get_ch1')
def get_ch1():
